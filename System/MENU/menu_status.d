...
{
	items[0] = "MENU_ITEM_STATUS_BACKGROUND";
...
const int STAT_A_X1 = 650; // 500; (by hand)
const int STAT_A_X2 = 1450; // 1300;
const int STAT_A_X3 = 2450; // 2300;
const int STAT_B_X1 = 3650; // 3500;
const int STAT_B_X2 = 5850; // 5700;
const int STAT_B_X3 = 7150; // 7200; (by hand)
...
instance MENU_ITEM_PLAYERGUILD_TITLE(C_MENU_ITEM_DEF)
{
	...
	fontname = MENU_FONT_BRIGHT; // STAT_FONT_DEFAULT; 
