...
INSTANCE PICKORE (C_PARTICLEFX)
{
	 ...
	 visname_s = "MINE_BRICK.TGA"; // Nyras Prolog Demake
     visorientation_s = "VELO";
...
INSTANCE PEE (C_PARTICLEFX)
{
     ...
     velvar = 4.99999989e-003;
     lsppartavg = 700.;
     flygravity_s = "0 -0.0025 0"; // NyrasPrologueDemake: Whistler's fix
...
INSTANCE BUTTERFLY_AREA_BIG_BLUE (PROTO_BUTTERFLY)
{
	visname_s = "BFLYBLUE_A0.TGA";
};

INSTANCE BUTTERFLY_AREA_BIG_ORANGE (PROTO_BUTTERFLY)
{
	visname_s = "BFLYORANGE_A0.TGA";
};

INSTANCE BUTTERFLY_AREA_BIG_YELLOW (PROTO_BUTTERFLY)
{
...
INSTANCE FIRE_LAMP (C_PARTICLEFX)
{
     ppsvalue = 25.000000000;
     ppsscalekeys_s = "1";
     ppsislooping = 1;
