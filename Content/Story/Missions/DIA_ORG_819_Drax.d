...
func void DIA_ORG_819_Drax_Hello_Info()
{
	...
	// Nyras knows about the camp (tested)
...
func void DIA_ORG_819_Drax_After_Hunting_Info()
{
	...
	{
		// DAMIANUT-TODO: Tak daæ warunki, by dwa razy nie u¿ywaæ tego samego dialogu
		if (Drax_HeroStartedFightAlone == true)
		{
			AI_Output	(self, hero, "Drax-CH0-G1RDemo_DraxHunt-Drax-50312");		//Zapomnij o œcierwojadach.
			AI_Output	(hero, self, "Drax-CH0-G1RDemo_DraxHunt-Hero-62484");		//Dlaczego?
	...
	// DAMIANUT-TODO: Raz uda³o mi siê odtworzyæ ten dialog. Zapisujê tu na wypadek, gdybym ustali³, jak to zrobiæ.
	if (false)
	{
...
// -> jak zaatakuje siê œcierwojady przed pierwsz¹ rozmow¹ z Draxem, to chce zabiæ
