...
func void TA_Smalltalk_Diego		(var int start_h, var int start_m, var int stop_h, var int stop_m, VAR string waypoint)	{TA_Min		(self,  start_h,start_m, stop_h, stop_m, ZS_Smalltalk_Diego,		waypoint);};

func void TA_Smalltalk_Whistler		(var int start_h, var int start_m, var int stop_h, var int stop_m, VAR string waypoint)	{TA_Min		(self,  start_h,start_m, stop_h, stop_m, ZS_Smalltalk_Whistler,		waypoint);};

func void TA_Sneak_Observe	        (var int start_h, var int start_m, var int stop_h, var int stop_m, VAR string waypoint)	{TA_Min		(self,  start_h,start_m, stop_h, stop_m, ZS_Sneak_Observe,		waypoint);};

func void TA_Ratford_Jorik	        (var int start_h, var int start_m, var int stop_h, var int stop_m, VAR string waypoint)	{TA_Min		(self,  start_h,start_m, stop_h, stop_m, ZS_Ratford_Jorik,		waypoint);};

func void TA_Start_Diego	    (var int start_h, var int start_m, var int stop_h, var int stop_m, VAR string waypoint)	{TA_Min		(self,  start_h,start_m, stop_h, stop_m, ZS_Start_Diego,	waypoint);};

func void TA_Start_Whistler	    (var int start_h, var int start_m, var int stop_h, var int stop_m, VAR string waypoint)	{TA_Min		(self,  start_h,start_m, stop_h, stop_m, ZS_Start_Whistler,	waypoint);};

func void TA_WoodChoppin_Diego	    (var int start_h, var int start_m, var int stop_h, var int stop_m, VAR string waypoint)	{TA_Min		(self,  start_h,start_m, stop_h, stop_m, ZS_WoodChoppin_Diego,	waypoint);};

func void TA_RunToHuntersCamp	    (var int start_h, var int start_m, var int stop_h, var int stop_m, VAR string waypoint)	{TA_Min		(self,  start_h,start_m, stop_h, stop_m, ZS_RunToHuntersCamp,	waypoint);};

func void TA_WaitHuntersCamp_Ratford	    (var int start_h, var int start_m, var int stop_h, var int stop_m, VAR string waypoint)	{TA_Min		(self,  start_h,start_m, stop_h, stop_m, ZS_WaitHuntersCamp_Ratford,	waypoint);};

func void TA_WaitHuntersCamp_Drax	    (var int start_h, var int start_m, var int stop_h, var int stop_m, VAR string waypoint)	{TA_Min		(self,  start_h,start_m, stop_h, stop_m, ZS_WaitHuntersCamp_Drax,	waypoint);};

func void TA_Inspect	    (var int start_h, var int start_m, var int stop_h, var int stop_m, VAR string waypoint)	{TA_Min		(self,  start_h,start_m, stop_h, stop_m, ZS_Inspect,	waypoint);};
...
func void TA_Drax_Hunt				(var int start_h, var int start_m, var int stop_h, var int stop_m, VAR string waypoint)	{TA_Min		(self,	start_h,start_m, stop_h, stop_m,ZS_Drax_Hunt	 ,			waypoint);};

func void TA_Trialog_Drax				(var int start_h, var int start_m, var int stop_h, var int stop_m, VAR string waypoint)	{TA_Min		(self,	start_h,start_m, stop_h, stop_m,ZS_Trialog_Drax	 ,			waypoint);};

func void TA_Trialog_Ratford				(var int start_h, var int start_m, var int stop_h, var int stop_m, VAR string waypoint)	{TA_Min		(self,	start_h,start_m, stop_h, stop_m,ZS_Trialog_Ratford	 ,			waypoint);};

func void TA_Start_Ratford				(var int start_h, var int start_m, var int stop_h, var int stop_m, VAR string waypoint)	{TA_Min		(self,	start_h,start_m, stop_h, stop_m,ZS_Start_Ratford	 ,			waypoint);};

func void TA_Sit_Crate				(var int start_h, var int start_m, var int stop_h, var int stop_m, VAR string waypoint)	{TA_Min		(self,	start_h,start_m, stop_h, stop_m,ZS_Sit_Crate	 ,			waypoint);};