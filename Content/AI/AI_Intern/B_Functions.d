...
//	
//////////////////////////////////////////////////////////////////////////
func void B_Attack(var C_Npc slf, var C_Npc oth, var int reason)
{
	// Save an attack reason
	B_SetAttackReason(slf, reason);
	
	// Assumes the hero will be killed
	if (AIV_AR_KILL == reason)
	{
...
//	B_LogEntry_Fake
//	==========
//	Play a sound and print a text without adding an entry.
//////////////////////////////////////////////////////////////////////////
func void B_LogEntry_Fake()
{
...
//////////////////////////////////////////////////////////////////////////
//	B_Ani_GiveItem
//   - two C_NPCs play animations of giving an item
//////////////////////////////////////////////////////////////////////////
func void B_Ani_GiveItem(var C_NPC giver, var C_NPC taker)
{
	PrintDebugNpc(PD_ZS_FRAME, "B_Ani_GiveItem");

	AI_WaitTillEnd(giver, taker);
