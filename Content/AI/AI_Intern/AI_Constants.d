...
const int 	AIV_SPECIALANILASTPLAYED		= 48;
const int 	AIV_SPECIALPERCSET				= 49;
...
const int	HAI_DIST_DIEGOWHISTLERSMALLTALK = 100;							// When Diego should come closer to Whistler.
const int 	HAI_DIST_WP						= 200;							// How close NPC has to be near an assigned WP
const int   HAI_DIST_RATFORD_AUTOWALK		= 600;							// In which distance hero has to go to Ratford automatically near Jorik's corpse
...
const int	HAI_TIME_UNCONSCIOUS_DUEL_HERO	= 5;							// NyrasPrologueDemake: hero stands up faster after a duel
