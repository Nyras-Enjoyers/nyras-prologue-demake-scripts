...
// NyrasPrologueDemake: perception of the smalltalk between Diego and Whistler
func void B_SmalltalkPerception()
{
	//  Wahrnehmungen aktiv 
	Npc_PercEnable  	(self, 	PERC_ASSESSENEMY		,	B_AssessEnemy				);
	Npc_PercEnable  	(self, 	PERC_ASSESSFIGHTER		,	B_AssessFighter				);
...
/*
 *  DraxHuntPerception
 *   - the perceptions while Drax is hunting
 */
func void DraxHuntPerception ()
{
 ...
 *
 * Perceptions for talk with more than 2 persons.
 */
func void Perception_Overdialog()
{
    self.senses         =   SENSE_HEAR | SENSE_SEE;
    self.senses_range   =   2000;
    Npc_SetPercTime(self, 0.01);
    Npc_PercEnable(self, PERC_ASSESSENTERROOM, B_AssessTalk_Overdialog);
};
