...
/*************************************************************************
**	Scavengers from "DraxHunt" quest (Nyras Prologue) 					**
*************************************************************************/

//FABIO-TODO
//USTAWI£EM STATYSTYKI TAKIE JAK M£ODY ŒCIERWOJAD ( W TYM SKALA MODELU), DO SPRAWDZENIA NA ILE HITÓW ITP ITD

instance DraxHuntScavenger_01	(MST_Default_Scavenger)
{
	level							=	4;
...
instance DraxHuntScavenger_02	(MST_Default_Scavenger)
{
	level							=	4;
...
instance DraxHuntScavenger_03	(MST_Default_Scavenger)
{
	level							=	4;
