...
//	HEILTRÄNKE																			//
/******************************************************************************************/
const string ItFo_Potion_Health_01_description = "Mikstura lecznicza uwarzona z rzadkich zió³. Jej b³yskawiczne w³aœciwoœci lecznicze uratowa³y ju¿ niezliczone istnienia, wiêc nie ma co siê dziwiæ, ¿e utalentowani alchemicy s¹ niezwykle cenieni w Kolonii.";
const string ItFo_Potion_Health_01_description_1 = "Mikstura lecznicza uwarzona z rzadkich zió³. Jej b³yskawiczne w³aœciwoœci";
const string ItFo_Potion_Health_01_description_2 = "lecznicze uratowa³y ju¿ niezliczone istnienia, wiêc nie ma co siê dziwiæ,";
const string ItFo_Potion_Health_01_description_3 = "¿e utalentowani alchemicy s¹ niezwykle cenieni w Kolonii.";
INSTANCE ItFo_Potion_Health_01(C_Item)
{
	...
	TEXT[3]				= ItFo_Potion_Health_01_description_1;
	TEXT[4]				= ItFo_Potion_Health_01_description_2;
	TEXT[5]				= ItFo_Potion_Health_01_description_3;
};
