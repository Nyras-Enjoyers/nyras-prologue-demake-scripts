...
/******************************************************************************************/
//	Dietrich
const string ItKe_Lockpick_description = "Niezbêdny dla tych, którzy potrafi¹ otwieraæ to, co jest zamkniête.";
...
/******************************************************************************************/
// zum Rumklimpern
const string ItMi_Lute_description = "Namacalne po³¹czenie ze œwiatem zewnêtrznym. Jej melodie pomagaj¹ zachowaæ zdrowy rozs¹dek i kulturê, przez co instrument jest nie mniej cenny ni¿ ruda.";
const string ItMi_Lute_description_1 = "Namacalne po³¹czenie ze œwiatem zewnêtrznym. Jej melodie pomagaj¹ zachowaæ";
const string ItMi_Lute_description_2 = "zdrowy rozs¹dek i kulturê, przez co instrument jest nie mniej cenny ni¿ ruda.";
...
/******************************************************************************************/
// Für Babe-Putzen
const string ItMi_Stuff_Brush_description = "Szczotki te s¹ czymœ wiêcej ni¿ tylko narzêdziem do czyszczenia – s¹ niezbêdne do utrzymania broni, pancerzy i zdrowia w dobrym stanie w trudnych warunkach panuj¹cych w Kolonii.";
const string ItMi_Stuff_Brush_description_1 = "Szczotki te s¹ czymœ wiêcej ni¿ tylko narzêdziem do czyszczenia –";
const string ItMi_Stuff_Brush_description_2 = "s¹ niezbêdne do utrzymania broni, pancerzy i zdrowia w dobrym stanie";
...
/******************************************************************************************/
const string ItMi_Orenugget_description = "Si³a napêdowa Kolonii. Unikalne w³aœciwoœci sprawiaj¹, ¿e jest zarówno walut¹, jak i po¿¹danym zasobem, kszta³tuj¹c tym samym dynamikê w³adzy w Kolonii i królestwie.";
const string ItMi_Orenugget_description_1 = "Si³a napêdowa Kolonii. Unikalne w³aœciwoœci sprawiaj¹, ¿e jest";
const string ItMi_Orenugget_description_2 = "zarówno walut¹, jak i po¿¹danym zasobem, kszta³tuj¹c tym samym";
const string ItMi_Orenugget_description_3 = "dynamikê w³adzy w Kolonii i królestwie.";
...
/******************************************************************************************/
//	Fackel			                					  **
const string ItMw_1H_Torch_description = "Niezast¹piona do poruszania siê po zdradliwych, pogr¹¿onych w mroku obszarach Kolonii. Mo¿e byæ u¿ywana jako prowizoryczna broñ przeciwko bestiom, czasami z ognistymi efektami.";
const string ItMw_1H_Torch_description_1 = "Niezast¹piona do poruszania siê po zdradliwych, pogr¹¿onych";
const string ItMw_1H_Torch_description_2 = "w mroku obszarach Kolonii. Mo¿e byæ u¿ywana jako prowizoryczna";
const string ItMw_1H_Torch_description_3 = "broñ przeciwko bestiom, czasami z ognistymi efektami.";
...
/******************************************************************************************/
const string ItMi_Stuff_Pipe_01_description = "Ceniona odrobina radoœci w Kolonii, czêsto u¿ywana do palenia miejscowych zió³.";
const string ItMi_Stuff_Pipe_01_description_1 = "Ceniona odrobina radoœci w Kolonii,";
const string ItMi_Stuff_Pipe_01_description_2 = "czêsto u¿ywana do palenia miejscowych zió³.";
...
/******************************************************************************************/
const string ItMi_Oldcoin_01_description = "Pozosta³oœæ po ¿yciu przed powstaniem bariery. Niegdyœ by³a cenna w Myrtanie, ale pod barier¹ jest bezwartoœciowa.";
const string ItMi_Oldcoin_01_description_1 = "Pozosta³oœæ po ¿yciu przed powstaniem bariery.";
const string ItMi_Oldcoin_01_description_2 = "Niegdyœ by³a cenna w Myrtanie, ale pod barier¹ jest bezwartoœciowa.";
...
/******************************************************************************************/
const string ItMi_Stuff_Plate_01_description = "Zu¿yte metalowe naczynie. Przypomina, ¿e nawet wiêŸniowie musz¹ jeœæ.";
...
/******************************************************************************************/
const string ItMi_Stuff_Amphore_01_description = "Naczynia bêd¹ce wspomnieniem po handlu przed powstaniem Kolonii, pe³ni¹ obecnie wiele funkcji w obozie.";
const string ItMi_Stuff_Amphore_01_description_1 = "Naczynia bêd¹ce wspomnieniem po handlu przed powstaniem";
