...
*********************************************************************************/
// VLK
const string ItMw_1H_Mace_Club_01_description = "Towarzysz Kopacza. Ta prymitywna, lecz skuteczna broñ jest odzwierciedleniem brutalnej prostoty ¿ycia w Kolonii.";
const string ItMw_1H_Mace_Club_01_description_1 = "Towarzysz Kopacza. Ta prymitywna, lecz skuteczna broñ";
const string ItMw_1H_Mace_Club_01_description_2 = "jest odzwierciedleniem brutalnej prostoty ¿ycia w Kolonii.";
...
{	
	...
	description			= name;
	TEXT[0] = ItMw_1H_Mace_Club_01_description_1;
	TEXT[1] = ItMw_1H_Mace_Club_01_description_2;
...
// VLK, SFB
const string ItMw_2H_Axe_Pickaxe = "Kilof";
const string ItMw_2H_Axe_Pickaxe_description = "Kilof to podstawowe narzêdzie w Kolonii. Mo¿na nim wydobywaæ magiczn¹ rudê, która jest g³ówn¹ walut¹ wykorzystywan¹ przez obozy. W doœwiadczonych rêkach kilof mo¿e równie¿ pos³u¿yæ jako broñ.";
const string ItMw_2H_Axe_Pickaxe_description_1 = "Kilof to podstawowe narzêdzie w Kolonii. Mo¿na nim wydobywaæ";
const string ItMw_2H_Axe_Pickaxe_description_2 = "magiczn¹ rudê, która jest g³ówn¹ walut¹ wykorzystywan¹ przez obozy.";
const string ItMw_2H_Axe_Pickaxe_description_3 = "W doœwiadczonych rêkach kilof mo¿e równie¿ pos³u¿yæ jako broñ.";
INSTANCE ItMwPickaxe (C_Item)
{
	name 				=	ItMw_2H_Axe_Pickaxe;
	...
	description			= name;
	TEXT[0] = ItMw_2H_Axe_Pickaxe_description_1;
	TEXT[1] = ItMw_2H_Axe_Pickaxe_description_2;
	TEXT[2] = ItMw_2H_Axe_Pickaxe_description_3;
...
/********************************************************************************/
// STT
const string ItMw_1H_Sword_Short_02_description = "Prosty krótki miecz ze srebrn¹ g³owic¹. Jego niewielki rozmiar sprawia, ¿e œwietnie sprawdza siê w szybkiej walce na krótki dystans.";
const string ItMw_1H_Sword_Short_02_description_1 = "Prosty krótki miecz ze srebrn¹ g³owic¹. Jego niewielki rozmiar sprawia,";
const string ItMw_1H_Sword_Short_02_description_2 = "¿e œwietnie sprawdza siê w szybkiej walce na krótki dystans.";
...
{	
	...
	description			= name;
	TEXT[0] = ItMw_1H_Sword_Short_02_description_1;
	TEXT[1] = ItMw_1H_Sword_Short_02_description_2;
	TEXT[2]				= NAME_Damage;					COUNT[2]	= damageTotal;
	TEXT[3] 			= NAME_Str_needed;				COUNT[3]	= cond_value[2];
	TEXT[4] 			= NAME_OneHanded;
	TEXT[5]				= NAME_Value;					COUNT[5]	= value;
...
/********************************************************************************/
// ORG
const string ItMw_1H_Mace_03_description = "Przera¿aj¹ca maczuga z metalow¹ g³owic¹ obit¹ kolcami. Stworzona tak, by imitowaæ œmiercionoœne u¿¹dlenie krwiopijców ¿yj¹cych na terenie Kolonii. Uwielbiana przez Szkodników. Jej charakterystyczny wygl¹d wzbudza strach.";
const string ItMw_1H_Mace_03_description_1 = "Przera¿aj¹ca maczuga z metalow¹ g³owic¹ obit¹ kolcami. Stworzona tak,";
const string ItMw_1H_Mace_03_description_2 = "by imitowaæ œmiercionoœne u¿¹dlenie krwiopijców ¿yj¹cych na terenie Kolonii.";
const string ItMw_1H_Mace_03_description_3 = "Uwielbiana przez Szkodników. Jej charakterystyczny wygl¹d wzbudza strach.";
...
{	
	...
	description			= name;
	TEXT[0]	= ItMw_1H_Mace_03_description_1;
	TEXT[1] = ItMw_1H_Mace_03_description_2;
	TEXT[2] = ItMw_1H_Mace_03_description_3;
	TEXT[3]				= NAME_Damage;					COUNT[3]	= damageTotal;
	TEXT[4] 			= NAME_Str_needed;				COUNT[4]	= cond_value[2];
	TEXT[5] 			= NAME_OneHanded;
};
...
*********************************************************************************/
// GRD
const string ItMw_1H_Sword_01_description = "Zwyk³y stalowy miecz z nieco zakrzywion¹ rêkojeœci¹. Standardowe wyposa¿enie ni¿szych rang¹ Stra¿ników ze Starego Obozu.";
const string ItMw_1H_Sword_01_description_1 = "Zwyk³y stalowy miecz z nieco zakrzywion¹ rêkojeœci¹.";
const string ItMw_1H_Sword_01_description_2 = "Standardowe wyposa¿enie ni¿szych rang¹ Stra¿ników ze Starego Obozu.";
...
{	
	...
	description			= name;
	TEXT[0] = ItMw_1H_Sword_01_description_1;
	TEXT[1] = ItMw_1H_Sword_01_description_2;
	TEXT[2]				= NAME_Damage;					COUNT[2]	= damageTotal;
	TEXT[3] 			= NAME_Str_needed;				COUNT[3]	= cond_value[2];
	TEXT[4] 			= NAME_OneHanded;
	TEXT[5]				= NAME_Value;					COUNT[5]	= value;
...
/********************************************************************************/
// GRD, STT (einer)
const string ItMw_1H_Sword_04_description = "Dobrej jakoœci miecz z ozdobnym wzorem i z¹bkowanym jelcem. Ze wzglêdu na swoj¹ wszechstronnoœæ jest preferowany przez doœwiadczonych wojowników.";
const string ItMw_1H_Sword_04_description_1 = "Dobrej jakoœci miecz z ozdobnym wzorem i z¹bkowanym jelcem. Ze wzglêdu na";
const string ItMw_1H_Sword_04_description_2 = "swoj¹ wszechstronnoœæ jest preferowany przez doœwiadczonych wojowników.";
...
{	
	...
	description			= name;
	TEXT[0] = ItMw_1H_Sword_04_description_1;
	TEXT[1] = ItMw_1H_Sword_04_description_2;
	TEXT[2]				= NAME_Damage;					COUNT[2]	= damageTotal;
	TEXT[3] 			= NAME_Str_needed;				COUNT[3]	= cond_value[2];
	TEXT[4] 			= NAME_OneHanded;
	TEXT[5]				= NAME_Value;					COUNT[5]	= value;
...
const string ItMw_1H_Sword_Old_01__BUSY = "Zardzewia³y miecz";
const string ItMw_1H_Sword_Old_01_description = "Relikt dawnych czasów Kolonii. Ten zniszczony orê¿ nadal jest u¿ywany przez nowych przybyszy.";
const string ItMw_1H_Sword_Old_01_description_1 = "Relikt dawnych czasów Kolonii. Ten zniszczony orê¿";
const string ItMw_1H_Sword_Old_01_description_2 = "nadal jest u¿ywany przez nowych przybyszy.";
INSTANCE AltesSchwert (C_Item)
{	
	name 				=	ItMw_1H_Sword_Old_01__BUSY;
	...
	visual 				=	"ItMw_1H_Sword_Old_01.3DS";
	//description			= "";
	TEXT[0]				= ItMw_1H_Sword_Old_01_description_1;
	////COUNT[0]			= ;
	TEXT[1]				= ItMw_1H_Sword_Old_01_description_2;
	////COUNT[1]			= ;
	TEXT[2]				= NAME_Damage;
	COUNT[2]			= damageTotal;
