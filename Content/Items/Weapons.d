...
//DIEGO
//-----------------------------------------------------------
const string ItRw_Bow_Diego = "£uk Diego";
const string ItRw_Bow_Diego_description = "Ten mistrzowsko wykonany d³ugi ³uk jest zarówno symbolem przywództwa Diego, jak i orê¿em.";
const string ItRw_Bow_Diego_description_1 = "Ten mistrzowsko wykonany d³ugi ³uk jest zarówno";
const string ItRw_Bow_Diego_description_2 = "symbolem przywództwa Diego, jak i orê¿em.";
...
//	owner 				= PC_THIEF;
	...
	description			= name;
	TEXT[0] = ItRw_Bow_Diego_description_1;
	TEXT[1] = ItRw_Bow_Diego_description_2;
	TEXT[2]				= NAME_Damage;					COUNT[2]	= damageTotal;
